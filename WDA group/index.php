...
<body>
    <section id="home">
        <div class="header">
            <a href="#home" class="headerText">home</a>
            <a href="#who-we-are" class="headerText">who we are</a>
            <a href="#Our_services" class="headerText">services</a>
            <a href="#our_work" class="headerText">our work</a>
    ...
    <div class="gridContainer">
        ...
        <div class="column-right bb-lightbluegray-fill"></div>
            ...
            <h1 class="waw-section-header bb-lightbluegray bb-bluegray-fill" id="who-we-are">who we are</h1>
                ...
                <div class="servicecontainer bb-bluegray-fill bb-lightbluegray">
                    <div class="service">
                        ...
                        <div class="feature">
                            ...
                            <p>Create a workplace in minutes. We also want to make work easy for workplace
                                administrators.
                                We make it possible to create a role- and conditions-based workplace that combines all
                                your
                ...
                <div class="servicecontainer bb-bluegray-fill bb-lightbluegray">
                    <div class="service">
                        ...
                        <div class="feature">
                            ...
                            <p>Keep everyone informed, no matter the change, things change especially in the world
                                today.
                        ...
                        <div class="feature">
                            ...
                            <p>Connect your colleagues and engage communities. If people don't know each other, they
                                can't
                                trust each other. If teams don't know what they're doing, they can't help each other.
                                Circle D.O.T.S.
                                connects teams and people in an organic way by letting them form Channels and Pages
                                around projects,
                        ...
                        <div class="feature">
                            ...
                            <p>For a better working environment, what can be measured, can be improved. Circle D.O.T.S.
                                ...
                                it easier to experiment and evaluate in a data-driven way. The secret weapon? The
                                world's
